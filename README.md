...
- **Landing Page**
    ...
    ![Landing Page](./assets/documentation/homepage.png)
...
- **post-details Page**
    ...
    ![forum details not logged in](./assets/documentation/notloggedin.png)
    ...
    ![forum details logged in](./assets/documentation/approved1.png)

    - comments

    ![forum comments logged in](./assets/documentation/approved2.png)
...
- **Register page**
    ...
    ![Register page](./assets/documentation/createaccount.png)
